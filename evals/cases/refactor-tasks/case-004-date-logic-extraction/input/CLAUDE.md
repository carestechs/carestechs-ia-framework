...
- Task generation for refactoring follows `../../../../../prompts/refactor-tasks.md` (relative to this file) together with the canonical task schema in `../../../../../prompts/base-template.md`.
