...
- Task generation for bug fixes follows `../../../../../prompts/bugfix-tasks.md` (relative to this file) together with the canonical task schema in `../../../../../prompts/base-template.md`.
