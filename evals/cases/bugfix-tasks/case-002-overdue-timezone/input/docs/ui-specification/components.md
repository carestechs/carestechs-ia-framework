...
**Description**: Draggable card rendering a task's title, assignee avatar, and due date. The due-date chip switches to `error` color once the due date has passed in the browser's local timezone (client-side check in the board screen).
