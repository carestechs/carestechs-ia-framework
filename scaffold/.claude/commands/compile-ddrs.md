...
4. Write the output per the routing table's Output column: `docs/component-examples.md`, plus updated `docs/ui-specification/index.md` (sections 2.1–2.6) and `CLAUDE.md` design sections — do not leave results only in chat.
