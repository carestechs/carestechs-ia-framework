---
description: Generate an implementation plan for a task (writes plans/plan-<WORK-ITEM-ID>-T-XXX-short-title.md)
---
...
4. Write the output file per the routing table's Output column: `plans/plan-<WORK-ITEM-ID>-T-XXX-short-title.md` — do not leave results only in chat.
