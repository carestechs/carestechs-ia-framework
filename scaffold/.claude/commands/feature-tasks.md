...
5. After writing the task list, run `python .ai-framework/tools/validate-tasks.py tasks/FEAT-XXX-tasks.md --work-item docs/work-items/FEAT-XXX-short-title.md` and fix every error.
