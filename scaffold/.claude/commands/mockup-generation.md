---
description: Generate a static HTML mockup for a screen (writes mockups/<WORK-ITEM-ID>-T-XXX-screen-name.html)
---
...
4. Write the output file per the routing table's Output column: `mockups/<WORK-ITEM-ID>-T-XXX-screen-name.html` — do not leave results only in chat.
