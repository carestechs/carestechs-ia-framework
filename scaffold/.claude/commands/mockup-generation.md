...
1. Read the required context files listed in the CLAUDE.md routing table row "UI mockup" — the target screen's spec and the Design System section of `docs/ui-specification.md`, plus `CLAUDE.md`.
